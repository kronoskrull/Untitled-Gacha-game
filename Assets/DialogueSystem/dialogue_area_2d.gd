...
const DialogueSystemPreload = preload("res://Assets/DialogueSystem/dialogue_system.tscn")
...
func _activate_dialogue() -> void:
	player_node.get_parent().get_parent().canSpin = false
	...
	get_parent().get_parent().add_child(new_dialogue)
