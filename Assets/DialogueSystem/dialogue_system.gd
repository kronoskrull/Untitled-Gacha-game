...
const DialogueButtonPreload = preload("res://Assets/DialogueSystem/dialogue_button.tscn")
...
func _choice_button_pressed(target_node: Node, wait_for_signal_to_continue: String):
	...
	#play audiostreamplayer here for pressing a button sound
